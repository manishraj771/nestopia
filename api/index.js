...
// Helper function to handle fetching property details based on intent
...
// Helper function to handle fetching property price based on intent
...
io.on("connection", (socket) => {
  ...
  // Send and receive messages within the socket connection
  socket.on("sendMessage", (data) => {
    io.to(data.receiverId).emit("getMessage", data);
  });

  // Join chat room based on user ID
...
// Starting the server and error handling
server.listen(port, () => {
